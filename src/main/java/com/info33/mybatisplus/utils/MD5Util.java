package com.info33.mybatisplus.utils;
...
public class MD5Util implements Serializable{
	...
	public static String getMDofFile( File file )
    {
    	if( file == null ){
    		return "";
    	}
     ...
     * @return
     */
    public static String getPassowrd( String password , String salt )
    {
    	return MD5Util.getMD5ofStr(  MD5Util.getMD5ofStr( password ) + salt );
    }
    ...
    public  static String MD5(String s) {
        ...
        //083CA41F2CFA69B4DA584EAB3DA1F935
        //083CA41F2CFA69B4DA584EAB3DA1F935
    }
